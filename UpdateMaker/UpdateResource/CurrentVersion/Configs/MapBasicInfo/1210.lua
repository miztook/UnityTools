local MapInfo = 
{
	...
	Monster = 
	{
		...
		[10118] = 
		{
			[1] = { x = 69.43, y = 48.33, z = -51.49, name = "劫掠者", level = 12, SortID = 394 },
		},
		[10119] = 
		{
			[1] = { x = 65.78, y = 49.19, z = -47.13, name = "劫掠者头目", level = 10, SortID = 395 },
		},
		[10122] = 
		{
			[1] = { x = 60.00, y = 51.82, z = -90.00, name = "信使", level = 15, SortID = 396 },
		},
		[10121] = 
		{
			[1] = { x = 186.60, y = 36.41, z = -29.30, name = "奴隶贩", level = 12, SortID = 1 },
		},
	},
	Npc = 
	{
		[727] = 
		{
			[1] = { x = 117.58, y = 67.02, z = 150.44, name = "莫妮卡", SortID = 388 },
		},
		[729] = 
		{
			[1] = { x = 112.29, y = 67.08, z = 154.91, name = "人类孤儿", SortID = 389 },
		},
		[728] = 
		{
			[1] = { x = 120.74, y = 66.71, z = 149.38, name = "塞勒斯", SortID = 390 },
		},
	},
	Region = 
	{
		[1] = 
		{
			[63] = { x = 39.14, y = 49.57, z = -229.65, xA = -2.98, yA = 28.67, zA = 182.82, name = "传送区域-好望港A", worldId = 110, IsCanFind = 1, Describe = "好望港-正门", PkMode = 1 },
		...
		[2] = 
		{
			...
			[61] = { x = 111.18, y = 101.57, z = 191.07, name = "格林镇西门", worldId = 0, PkMode = 1 },
			[62] = { x = -222.68, y = 42.90, z = -170.96, name = "幽林营地", worldId = 0, PkMode = 1 },
			...
			[71] = { x = 126.49, y = 79.84, z = 58.06, name = "难民营", worldId = 0, PkMode = 1 },
			[72] = { x = 7.77, y = 50.53, z = 64.87, name = "农场", worldId = 0, PkMode = 1 },
			[73] = { x = 145.40, y = 39.42, z = -39.67, name = "海盗营地外", worldId = 0, PkMode = 1 },
			[74] = { x = -111.55, y = 62.28, z = 191.93, name = "洛卡伐木场", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[77] = { x = -150.77, y = 75.86, z = 122.83, name = "游侠营地", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[78] = { x = 173.66, y = 27.64, z = -173.21, name = "毒蛇竞技场", worldId = 0, IsCanFind = 1, PkMode = 1 },
			...
			[89] = { x = -234.49, y = 87.86, z = 81.99, name = "巴哈勒祭坛", worldId = 0, PkMode = 1 },
			...
			[94] = { x = 178.01, y = 81.40, z = 180.85, name = "格林镇", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[95] = { x = 147.48, y = 69.89, z = 247.36, name = "行商分会", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[96] = { x = 212.81, y = 76.04, z = 227.93, name = "教堂广场", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[97] = { x = 155.59, y = 102.64, z = 152.26, name = "联盟广场", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[98] = { x = 217.58, y = 59.72, z = 110.11, name = "格林镇南门", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[99] = { x = 23.62, y = 62.41, z = 227.20, name = "悬崖", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[100] = { x = -13.58, y = 54.24, z = 17.64, name = "坎贝尔农庄", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[101] = { x = -152.65, y = 177.43, z = 157.23, name = "洛卡森林", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[102] = { x = -141.34, y = 200.98, z = 110.52, name = "游侠营地", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[103] = { x = -137.74, y = 44.26, z = -176.92, name = "贪婪溪谷", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[104] = { x = 186.19, y = 36.00, z = -30.30, name = "海盗巢穴", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[105] = { x = -211.75, y = 50.56, z = -201.41, name = "幽林营地", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[106] = { x = 36.82, y = 49.63, z = -177.84, name = "好望港大门", worldId = 0, IsCanFind = 1, PkMode = 1 },
			...
			[332] = { x = 115.53, y = 67.04, z = 183.06, name = "格林镇西门", worldId = 0, PkMode = 1 },
