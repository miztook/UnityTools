local MapInfo = 
{
	...
	Region = 
	{
		...
		[2] = 
		{
			...
			[74] = { x = -111.55, y = 62.28, z = 191.93, name = "洛卡伐木场", worldId = 0, PkMode = 1 },
			[77] = { x = -150.77, y = 75.86, z = 122.83, name = "游侠营地", worldId = 0, PkMode = 1 },
			[78] = { x = 173.66, y = 27.64, z = -173.21, name = "毒蛇竞技场", worldId = 0, PkMode = 1 },
			...
			[332] = { x = 115.53, y = 67.04, z = 183.06, name = "格林镇西门", worldId = 0, PkMode = 0 },
