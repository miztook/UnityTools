local MapInfo = 
{
	...
	Monster = 
	{
		[23120] = 
		{
			[1] = { x = 0.14, y = 6.70, z = -110.45, name = "혈전사", level = 36 },
			[2] = { x = 0.14, y = 6.70, z = -105.58, name = "혈전사", level = 36 },
		},
		[23122] = 
		{
			[1] = { x = 21.98, y = 0.93, z = -83.42, name = "검은 날개 병사", level = 36 },
			[2] = { x = 27.18, y = 0.93, z = -83.42, name = "검은 날개 병사", level = 36 },
			[3] = { x = 0.53, y = 1.87, z = -22.97, name = "검은 날개 병사", level = 36 },
		},
		[23124] = 
		{
			[1] = { x = 27.18, y = 0.93, z = -83.42, name = "데바 사제", level = 36 },
			[2] = { x = 0.53, y = 1.87, z = -22.97, name = "데바 사제", level = 36 },
		},
		[23126] = 
		{
			[1] = { x = -0.04, y = 5.77, z = -59.36, name = "데바 사제", level = 36 },
		},
		[23127] = 
		{
			[1] = { x = -0.04, y = 5.77, z = -59.36, name = "검은 날개 병사", level = 36 },
			[2] = { x = 5.06, y = 5.77, z = -58.30, name = "검은 날개 병사", level = 36 },
		},
		[23123] = 
		{
			[1] = { x = 0.55, y = 1.87, z = -34.39, name = "검은 날개 사제", level = 36 },
			[2] = { x = 0.53, y = 1.87, z = -29.51, name = "검은 날개 사제", level = 36 },
			[3] = { x = 0.53, y = 1.87, z = -24.13, name = "검은 날개 사제", level = 36 },
		},
		[23125] = 
		{
			[1] = { x = 0.53, y = 1.87, z = -18.86, name = "데바 지휘관", level = 36 },
		},
		[23220] = 
		{
			[1] = { x = 0.45, y = 1.87, z = -18.80, name = "검은 날개 대주교", level = 36 },
		},
		[23221] = 
		{
			[1] = { x = -0.14, y = 5.67, z = 28.52, name = "방주 순찰병 A형", level = 36 },
		},
		[23222] = 
		{
			[1] = { x = -0.14, y = 5.67, z = 28.52, name = "방주 순찰병 B형", level = 36 },
		},
		[23320] = 
		{
			[1] = { x = -0.20, y = 5.67, z = 37.24, name = "방주 수호자", level = 36,IsBoss = true },
		},
		[23321] = 
		{
			[1] = { x = 0.00, y = 5.67, z = 19.56, name = "방주 수호자", level = 36,IsBoss = true },
			[2] = { x = 0.00, y = 5.67, z = 19.56, name = "방주 수호자", level = 36,IsBoss = true },
		},
		[23322] = 
		{
			[1] = { x = 0.00, y = 5.67, z = 19.56, name = "방주 수호자", level = 36,IsBoss = true },
