local MapInfo = 
{
	...
	Monster = 
	{
		[10120] = 
		{
			[1] = { x = 124.72, y = 18.98, z = 223.95, name = "실성한 영혼", level = 14, SortID = 1 },
		},
		[10191] = 
		{
	...
	Npc = 
	{
		[213] = 
		{
			[1] = { x = 121.64, y = 18.98, z = 213.01, name = "손님", SortID = 95 },
			[2] = { x = 62.08, y = 23.30, z = 168.69, name = "손님", SortID = 126 },
		},
		[214] = 
		{
			[1] = { x = 118.57, y = 18.98, z = 214.15, name = "손님", SortID = 96 },
		},
		[215] = 
		{
			[1] = { x = 123.46, y = 18.98, z = 207.81, name = "손님", SortID = 97 },
			[2] = { x = 62.93, y = 23.30, z = 166.73, name = "손님", SortID = 125 },
		},
		[15] = 
		{
			[1] = { x = 51.41, y = 18.52, z = 184.29, name = "셀러스", IsCanFind = 1, IconPath = "Common_Npc_013", Describe = "셀러스", SortID = 138, FunctionName = "명성" },
		},
		[16] = 
		{
			[1] = { x = 127.24, y = 18.98, z = 223.17, name = "소녀 유령", SortID = 139 },
		},
		[233] = 
		{
			[1] = { x = 92.02, y = 21.41, z = 164.89, name = "소녀", SortID = 142 },
			[2] = { x = -5.37, y = 32.83, z = 120.43, name = "소녀", SortID = 143 },
		},
		[19] = 
		{
		...
		[733] = 
		{
			[1] = { x = 132.94, y = 22.03, z = 109.00, name = "타일론", SortID = 116 },
		},
	},
	Region = 
	{
