local MapInfo = 
{
	...
	Monster = 
	{
		[14228] = 
		{
			[1] = { x = 348.60, y = 30.15, z = 21.38, name = "타락한 검은 날개 약탈자", level = 54, SortID = 18, DropItemIds = " " },
			[2] = { x = 330.00, y = 30.15, z = 23.13, name = "타락한 검은 날개 약탈자", level = 54, SortID = 20, DropItemIds = " " },
			[3] = { x = 338.00, y = 30.15, z = 30.46, name = "타락한 검은 날개 약탈자", level = 54, SortID = 21, DropItemIds = " " },
		},
		[14258] = 
		{
			[1] = { x = 263.30, y = -9.82, z = 63.91, name = "불사의 근위병", level = 55, SortID = 19, DropItemIds = " " },
			[2] = { x = 259.90, y = -9.82, z = 38.20, name = "불사의 근위병", level = 55, SortID = 23, DropItemIds = " " },
			[3] = { x = 239.10, y = -9.82, z = 38.20, name = "불사의 근위병", level = 55, SortID = 24, DropItemIds = " " },
			[4] = { x = 235.40, y = -9.82, z = 54.00, name = "불사의 근위병", level = 55, SortID = 25, DropItemIds = " " },
			[5] = { x = 237.70, y = -9.82, z = 24.10, name = "불사의 근위병", level = 55, SortID = 26, DropItemIds = " " },
			[6] = { x = 249.10, y = -9.82, z = 48.70, name = "불사의 근위병", level = 55, SortID = 27, DropItemIds = " " },
			[7] = { x = 271.70, y = -9.82, z = 48.40, name = "불사의 근위병", level = 55, SortID = 28, DropItemIds = " " },
		},
		[14229] = 
		{
			[1] = { x = 338.00, y = 30.37, z = 52.49, name = "타락한 검은 날개 사제", level = 54, SortID = 15, DropItemIds = " " },
			[2] = { x = 324.89, y = 30.37, z = 52.36, name = "타락한 검은 날개 사제", level = 54, SortID = 16, DropItemIds = " " },
			[3] = { x = 332.74, y = 30.37, z = 66.86, name = "타락한 검은 날개 사제", level = 54, SortID = 22, DropItemIds = " " },
		},
		[14312] = 
		{
	...
	Npc = 
	{
		...
		[2033] = 
		{
			[1] = { x = 338.90, y = 30.40, z = 8.80, name = "시칸다리 병사", SortID = 13, FunctionName = " " },
		},
	},
	Region = 
	{
