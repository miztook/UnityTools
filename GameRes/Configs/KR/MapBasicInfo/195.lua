local MapInfo = 
{
	...
	Monster = 
	{
		[14036] = 
		{
			[1] = { x = 135.01, y = 24.72, z = 306.62, name = "사마엘", level = 60, SortID = 1 },
		},
		[14037] = 
		{
			[1] = { x = 134.22, y = 24.70, z = 313.65, name = "조나단", level = 60, SortID = 2 },
		},
		[14002] = 
		{
			[1] = { x = 138.21, y = 21.25, z = 246.70, name = "언데드 연합군", level = 59, SortID = 7 },
		},
	},
	Npc = 
	{
		[4060] = 
		{
			[1] = { x = 143.33, y = 24.70, z = 295.58, name = "카타야 라흐나", SortID = 3 },
		},
		[4019] = 
		{
			[1] = { x = 135.01, y = 24.70, z = 306.03, name = "사마엘", SortID = 4 },
		},
		[4061] = 
		{
			[1] = { x = 134.23, y = 21.30, z = 230.92, name = "엘리사 쿠벨", SortID = 5 },
		},
		[4032] = 
		{
