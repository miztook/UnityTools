local MapInfo = 
{
	...
	Monster = 
	{
		[14205] = 
		{
			[1] = { x = 42.37, y = 71.02, z = 138.07, name = "尼古拉斯", level = 60, SortID = 3,IsBoss = true },
		},
		[14202] = 
		{
			[1] = { x = 53.20, y = 71.01, z = 143.80, name = "尼古拉斯", level = 60, SortID = 4,IsBoss = true },
			[2] = { x = 3.00, y = 71.02, z = -70.40, name = "尼古拉斯", level = 60, SortID = 10,IsBoss = true },
		},
		[14203] = 
		{
			[1] = { x = 28.00, y = 71.02, z = 130.00, name = "尼古拉斯", level = 60, SortID = 1,IsBoss = true },
		},
		[14204] = 
		{
			[1] = { x = -18.80, y = 71.02, z = 104.00, name = "地图5-塔雷坤平台【相位】-空怪3", level = 60, SortID = 6 },
			[2] = { x = 2.00, y = 71.02, z = 138.70, name = "地图5-塔雷坤平台【相位】-空怪3", level = 60, SortID = 7 },
			[3] = { x = 23.10, y = 71.02, z = 102.80, name = "地图5-塔雷坤平台【相位】-空怪3", level = 60, SortID = 8 },
		},
		[14201] = 
		{
			[1] = { x = 21.70, y = 71.02, z = 126.10, name = "尼古拉斯", level = 56, SortID = 2,IsBoss = true },
		},
	},
	Npc = 
	{
		[4219] = 
		{
			[1] = { x = 13.98, y = 71.02, z = 117.70, name = "贝里克化身", SortID = 5 },
		},
	},
	Region = 
	{
