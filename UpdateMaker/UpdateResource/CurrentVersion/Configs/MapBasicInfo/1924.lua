local MapInfo = 
{
	...
	Monster = 
	{
		...
		[14296] = 
		{
			[1] = { x = 167.70, y = 70.52, z = -34.80, name = "血祭师", level = 59, SortID = 17, DropItemIds = " ",IsBoss = true },
		},
		[14298] = 
		{
		...
		[14311] = 
		{
			[1] = { x = 260.28, y = 70.52, z = -71.44, name = "温妮莎", level = 60, SortID = 52, DropItemIds = " " },
		},
		[14310] = 
		{
			[1] = { x = 260.28, y = 70.52, z = -71.44, name = "乔纳森", level = 60, SortID = 52, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[4242] = 
		{
			[1] = { x = 24.59, y = 58.54, z = -50.65, name = "艾利恩·库贝尔", SortID = 1, FunctionName = " " },
		},
		[4046] = 
		{
			[1] = { x = 258.80, y = 70.64, z = -16.60, name = "凯亚之剑守卫", SortID = 25, FunctionName = " " },
			[2] = { x = 226.10, y = 61.73, z = 35.90, name = "凯亚之剑守卫", SortID = 37, FunctionName = " " },
			[3] = { x = 192.00, y = 61.65, z = 37.10, name = "凯亚之剑守卫", SortID = 38, FunctionName = " " },
			[4] = { x = 257.00, y = 61.65, z = 34.90, name = "凯亚之剑守卫", SortID = 39, FunctionName = " " },
			[5] = { x = 261.20, y = 70.64, z = -41.20, name = "凯亚之剑守卫", SortID = 40, FunctionName = " " },
		},
		[4248] = 
		{
			[1] = { x = 260.22, y = 70.52, z = -65.54, name = "乔纳森", SortID = 48, FunctionName = " " },
		},
		[4246] = 
		{
			[1] = { x = 262.06, y = 70.52, z = -73.80, name = "温妮莎·德佩拉", SortID = 49, FunctionName = " " },
		},
		[4244] = 
		{
			[1] = { x = 269.47, y = 70.52, z = -65.83, name = "沙摩尔", SortID = 50, FunctionName = " " },
		},
		[4245] = 
		{
			[1] = { x = 271.96, y = 70.52, z = -69.79, name = "卡塔娅·拉赫纳", SortID = 51, FunctionName = " " },
		},
	},
	Region = 
	{
		[2] = 
		{
			[335] = { x = 150.92, y = 58.18, z = -31.55, name = "卡斯塔仑", worldId = 0, PkMode = 0, IsCanHawkeye = true, QuestID = {4572} },
