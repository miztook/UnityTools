local MapInfo = 
{
	...
	Npc = 
	{
		[4211] = 
		{
			[1] = { x = -185.20, y = 95.01, z = 323.30, name = "德法精锐士兵", SortID = 2 },
		},
		[4214] = 
		{
			[1] = { x = -207.00, y = 95.00, z = 331.74, name = "帝国黑法师", SortID = 1 },
			[2] = { x = -230.53, y = 95.11, z = 340.90, name = "帝国黑法师", SortID = 7 },
		},
		[4212] = 
		{
			[1] = { x = -228.43, y = 95.01, z = 339.98, name = "维基·奇·纳罗费雷", SortID = 3 },
		},
		[4209] = 
		{
			[1] = { x = -218.85, y = 95.01, z = 344.18, name = "迪波", SortID = 4 },
		},
		[4208] = 
		{
			[1] = { x = -221.52, y = 95.11, z = 337.42, name = "温妮莎·德佩拉", SortID = 5 },
		},
		[4213] = 
		{
			[1] = { x = -224.54, y = 95.01, z = 330.17, name = "卡斯塔尼克人", SortID = 6 },
		},
	},
	Region = 
	{
		[2] = 
		{
			[465] = { x = -172.91, y = 95.12, z = 340.35, name = "塔雷坤相关相位", worldId = 0, PkMode = 1 },
			[466] = { x = -213.69, y = 95.01, z = 334.57, name = "抵达区域", worldId = 0, PkMode = 1 },
		},
	},
	Mine = 
	{
