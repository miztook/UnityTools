local MapInfo = 
{
	...
	Monster = 
	{
		[14051] = 
		{
			[1] = { x = -3.28, y = 28.93, z = 164.36, name = "폭도", level = 52, SortID = 1 },
		},
		[14050] = 
		{
			[1] = { x = -3.46, y = 32.83, z = 123.00, name = "희망항 반란군", level = 52, SortID = 3 },
			[2] = { x = -63.72, y = 31.41, z = 125.86, name = "희망항 반란군", level = 52, SortID = 4 },
		},
		[14052] = 
		{
			[1] = { x = -96.45, y = 44.22, z = 59.42, name = "데바 스파이", level = 52, SortID = 5 },
		},
	},
	Npc = 
	{
		[744] = 
		{
			[1] = { x = -80.52, y = 44.22, z = 58.26, name = "미트라", SortID = 6 },
		},
		[745] = 
		{
			[1] = { x = -82.45, y = 44.33, z = 59.33, name = "드레토", SortID = 7 },
		},
		[742] = 
		{
			[1] = { x = -3.63, y = 34.86, z = 106.87, name = "캘리 발레토", SortID = 8 },
		},
		[741] = 
		{
			[1] = { x = -86.11, y = 44.33, z = 61.63, name = "셀러스", SortID = 9 },
		},
		[743] = 
		{
			[1] = { x = -88.54, y = 44.33, z = 61.83, name = "레이언", SortID = 10 },
		},
	},
	Region = 
	{
		[1] = 
		{
			...
			[2] = { x = -113.82, y = 29.13, z = 142.47, xA = -21.32, yA = 53.58, zA = -242.44, name = "传送2", worldId = 120, IsCanFind = 1, Describe = "동부 가드 - 탐욕의 골짜기", PkMode = 1 },
			...
			[91] = { x = -28.68, y = 58.38, z = -36.51, xA = -5.80, yA = 179.30, zA = -138.31, name = "区域", worldId = 110, IsCanFind = 1, Describe = "천공 신전", PkMode = 1 },
