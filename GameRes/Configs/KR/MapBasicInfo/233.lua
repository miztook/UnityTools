local MapInfo = 
{
	...
	Monster = 
	{
		[22400] = 
		{
			[1] = { x = -9.00, y = 76.02, z = 86.58, name = "이스렌 수련자", level = 42,IsBoss = true },
		},
		[22401] = 
		{
			[1] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 42 },
			[2] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 42 },
			[3] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 42 },
			[4] = { x = -9.10, y = 76.02, z = 67.30, name = "환영", level = 42 },
			[5] = { x = -9.10, y = 76.02, z = 69.29, name = "환영", level = 42 },
		},
		[22403] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 42 },
		},
		[22404] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 42 },
		...
		[22405] = 
		{
			[1] = { x = 36.71, y = 64.99, z = -20.82, name = "환영", level = 42 },
		},
		[22406] = 
		{
			[1] = { x = -8.80, y = 57.66, z = -90.69, name = "타락한 엘프", level = 42 },
		},
		[22402] = 
		{
			[1] = { x = -8.60, y = 76.02, z = 70.70, name = "환영", level = 42 },
		},
	},
	Npc = 
	{
