local MapInfo = 
{
	...
	Monster = 
	{
		[12000] = 
		{
			[1] = { x = -233.84, y = -17.66, z = -163.06, name = "사냥개의 그림자", level = 30, SortID = 20 },
			[2] = { x = -228.81, y = -17.76, z = -166.45, name = "사냥개의 그림자", level = 30, SortID = 21 },
		},
		[12001] = 
		{
		...
		[12002] = 
		{
			[1] = { x = -218.10, y = -6.71, z = -78.00, name = "노예 병사의 그림자", level = 30, IsCanFind = 1, Describe = "Lv.30 데바 그림자", SortID = 22, DropItemIds = "1001*1109*20100*1108*52*27010*24000*20200*20201*1107*24001*20300*3000*2022*1030*20202*24002*21101" },
		},
		[12003] = 
		{
			[1] = { x = -225.21, y = -6.74, z = -60.56, name = "검투사의 그림자", level = 30, SortID = 25 },
			[2] = { x = -225.40, y = -6.64, z = -87.33, name = "검투사의 그림자", level = 30, SortID = 27 },
			[3] = { x = -224.56, y = -5.03, z = -75.00, name = "검투사의 그림자", level = 30, SortID = 28 },
			[4] = { x = -228.81, y = -6.74, z = -81.52, name = "검투사의 그림자", level = 30, SortID = 23 },
		},
		[12011] = 
		{
			[1] = { x = 52.00, y = 10.30, z = -73.60, name = "검은 날개 약탈자", level = 34, IsCanFind = 1, Describe = "Lv.34 검은 날개의 약탈자", SortID = 33, DropItemIds = "1001*1109*20100*1108*51*20010*27010*24000*20200*20201*1107*27011*24001*20300*3000*2022*1030*20202*24002*21201" },
		},
		[119] = 
		{
		...
		[12012] = 
		{
			[1] = { x = -30.89, y = 2.18, z = -119.86, name = "검은 날개 탈옥자", level = 33, SortID = 42 },
			[2] = { x = -22.32, y = 1.82, z = -104.07, name = "검은 날개 탈옥자", level = 33, SortID = 43 },
			[3] = { x = -36.77, y = 3.30, z = -104.54, name = "검은 날개 탈옥자", level = 33, SortID = 44 },
			[4] = { x = -46.61, y = 3.30, z = -115.24, name = "검은 날개 탈옥자", level = 33, SortID = 46 },
		},
		[12013] = 
		{
			[1] = { x = -46.61, y = 3.30, z = -115.24, name = "검은 날개 탈옥자 두목", level = 33, SortID = 46 },
		},
		[12015] = 
		{
		...
		[12081] = 
		{
			[1] = { x = -272.34, y = -3.45, z = -32.92, name = "언데드 장교의 그림자", level = 32, SortID = 186 },
		},
		[12082] = 
		{
		...
		[12072] = 
		{
			[1] = { x = -362.50, y = -5.33, z = -85.10, name = "숲 매머드", level = 32, IsCanFind = 1, Describe = "레벨32 숲 매머드", SortID = 189, DropItemIds = "1001*1109*20100*1108*52*27010*24000*20200*20201*1107*24001*20300*3000*2022*1030*20202*24002*21101" },
			[2] = { x = -365.24, y = -5.31, z = -101.87, name = "숲 매머드", level = 32, SortID = 223 },
		},
		[12073] = 
		{
			[1] = { x = -197.52, y = 0.17, z = -11.20, name = "검붉은 타조", level = 32, SortID = 190 },
			[2] = { x = -205.40, y = 0.17, z = 18.05, name = "검붉은 타조", level = 32, SortID = 191 },
	...
	Npc = 
	{
		...
		[2019] = 
		{
			...
			[8] = { x = 58.65, y = 21.04, z = 17.14, name = "케스타닉 호위병", SortID = 124 },
			[9] = { x = 57.05, y = 21.04, z = 21.29, name = "케스타닉 호위병", SortID = 125 },
		...
		[2024] = 
		{
			[1] = { x = 58.77, y = 21.04, z = 43.69, name = "쉐도우 거미", SortID = 87 },
		},
		[2043] = 
		{
		...
		[2000] = 
		{
			...
			[2] = { x = -223.78, y = 0.17, z = -18.22, name = "루나 엘린", SortID = 108 },
		},
		[2037] = 
		{
		...
		[2005] = 
		{
			[1] = { x = -284.87, y = -3.45, z = -55.15, name = "루나 엘린", SortID = 112 },
		},
		[2038] = 
		{
		...
		[2081] = 
		{
			[1] = { x = -272.56, y = -8.38, z = -76.59, name = "아이리스", SortID = 163 },
		},
		[2082] = 
		{
		...
		[2084] = 
		{
			[1] = { x = -285.21, y = -8.38, z = -79.67, name = "노장", SortID = 166 },
		},
		[2085] = 
		{
		...
		[2213] = 
		{
			[1] = { x = -373.34, y = -1.68, z = -147.93, name = "포위된 여행객", SortID = 259 },
		},
		[2214] = 
		{
		...
		[2270] = 
		{
			[1] = { x = -347.06, y = -4.36, z = -125.72, name = "사냥꾼의 집", IsCanFind = 1, IconPath = "Common_Npc_013", Describe = "사냥꾼의 집", SortID = 70, FunctionName = "명성" },
		},
		[2275] = 
		{
			[1] = { x = 24.84, y = 21.04, z = 51.23, name = "호가스 사신과 대화하기", SortID = 216, FunctionName = " " },
		},
	},
	Region = 
	{
		...
		[2] = 
		{
			...
			[193] = { x = -198.14, y = 59.64, z = -65.22, name = "버려진 데바 주둔지", isShowName = true, worldId = 0, PkMode = 0 },
			...
			[201] = { x = 39.88, y = 30.46, z = 76.43, name = "루린 마을", isShowName = true, worldId = 0, PkMode = 0 },
