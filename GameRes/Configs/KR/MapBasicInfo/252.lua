local MapInfo = 
{
	...
	Monster = 
	{
		[24110] = 
		{
			[1] = { x = -17.29, y = 82.35, z = -108.42, name = "엘프 검사", level = 45 },
			[2] = { x = -26.68, y = 80.01, z = -79.64, name = "엘프 검사", level = 45 },
			[3] = { x = -7.15, y = 80.01, z = -81.04, name = "엘프 검사", level = 45 },
			[4] = { x = -17.23, y = 80.01, z = -90.59, name = "엘프 검사", level = 45 },
		},
		[24111] = 
		{
			[1] = { x = -26.68, y = 80.01, z = -79.64, name = "엘프 궁수", level = 45 },
			[2] = { x = -7.15, y = 80.01, z = -81.04, name = "엘프 궁수", level = 45 },
			[3] = { x = -17.23, y = 80.01, z = -90.59, name = "엘프 궁수", level = 45 },
		},
		[24112] = 
		{
			[1] = { x = -51.84, y = 75.35, z = -71.84, name = "사막 행인", level = 45 },
			[2] = { x = -54.81, y = 75.35, z = -80.90, name = "사막 행인", level = 45 },
			[3] = { x = -52.12, y = 76.92, z = -39.38, name = "사막 행인", level = 45 },
			[4] = { x = -51.97, y = 76.92, z = -47.98, name = "사막 행인", level = 45 },
			[5] = { x = -50.09, y = 71.87, z = -2.49, name = "사막 행인", level = 45 },
			[6] = { x = -13.71, y = 62.76, z = 5.25, name = "사막 행인", level = 45 },
		},
		[24203] = 
		{
			[1] = { x = -52.12, y = 76.92, z = -39.38, name = "정예 사막 행인", level = 45 },
		},
		[24113] = 
		{
			[1] = { x = -51.97, y = 76.92, z = -47.98, name = "감염자", level = 45 },
			[2] = { x = -50.09, y = 71.87, z = -2.49, name = "감염자", level = 45 },
			[3] = { x = -13.71, y = 62.76, z = 5.25, name = "감염자", level = 45 },
		},
		[24114] = 
		{
			[1] = { x = -7.51, y = 62.76, z = 14.25, name = "바람의 사제", level = 45 },
			[2] = { x = 31.18, y = 55.31, z = 9.77, name = "바람의 사제", level = 45 },
			[3] = { x = 26.10, y = 55.31, z = 14.13, name = "바람의 사제", level = 45 },
		},
		[24115] = 
		{
			[1] = { x = -7.51, y = 62.76, z = 14.25, name = "바람의 전사", level = 45 },
			[2] = { x = 26.10, y = 55.31, z = 14.13, name = "바람의 전사", level = 45 },
		},
		[24204] = 
		{
			[1] = { x = 31.18, y = 55.31, z = 9.77, name = "소르나", level = 45 },
		},
		[24310] = 
		{
			[1] = { x = 5.49, y = 40.50, z = -35.71, name = "셀리온", level = 45,IsBoss = true },
		},
		[24302] = 
		{
	...
	Region = 
	{
		[2] = 
		{
			[1] = { x = -17.14, y = 82.60, z = -124.14, name = "目标1区域", worldId = 0, PkMode = 1 },
			[2] = { x = -17.35, y = 81.23, z = -101.80, name = "目标3区域", worldId = 0, PkMode = 1 },
			[3] = { x = -32.83, y = 80.30, z = -81.04, name = "目标5区域", worldId = 0, PkMode = 1 },
			[275] = { x = -51.75, y = 77.00, z = -44.84, name = "触发沙行者精英区", worldId = 0, PkMode = 1 },
			[276] = { x = -50.56, y = 72.10, z = -3.24, name = "目标8_穿过塌陷区域", worldId = 0, PkMode = 1 },
			...
			[331] = { x = 12.21, y = 40.50, z = -29.41, name = "BOSS区域", worldId = 0, BattleMusic = "BGM_Dunjeon/Dunjeon/DUNJEON_BATTLE", PkMode = 1 },
		},
	},
	Mine = 
	{
