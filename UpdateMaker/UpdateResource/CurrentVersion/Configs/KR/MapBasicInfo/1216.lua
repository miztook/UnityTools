local MapInfo = 
{
	...
	Region = 
	{
		[2] = 
		{
			[1] = { x = 185.73, y = 46.53, z = 24.27, name = "进入点", worldId = 0, PkMode = 1 },
			[2] = { x = 186.29, y = 121.94, z = 20.30, name = "更亮", worldId = 0, PkMode = 1 },
			[3] = { x = 173.80, y = 47.48, z = 1.20, name = "范围", worldId = 0, PkMode = 1 },
		},
	},
	Mine = 
	{
