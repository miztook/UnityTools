local MapInfo = 
{
	...
	Monster = 
	{
		[13146] = 
		{
			[1] = { x = -68.18, y = 78.13, z = -99.31, name = "腐化沙摩尔", level = 45, SortID = 1, DropItemIds = " " },
		},
		[13145] = 
		{
			[1] = { x = -71.30, y = 77.51, z = -87.30, name = "诅咒之魂", level = 45, SortID = 10, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[3323] = 
		{
			[1] = { x = -68.43, y = 78.13, z = -99.54, name = "魔化沙摩尔", SortID = 7, FunctionName = " " },
		},
		[3324] = 
		{
			[1] = { x = -72.46, y = 78.13, z = -97.44, name = "艾丽莎·库贝尔", SortID = 8, FunctionName = " " },
		},
		[3325] = 
		{
			[1] = { x = -76.49, y = 77.86, z = -96.46, name = "游侠士兵", SortID = 9, FunctionName = " " },
		},
	},
	Region = 
	{
