local MapInfo = 
{
	...
	Monster = 
	{
		[13113] = 
		{
			[1] = { x = 293.24, y = 52.47, z = -58.77, name = "", level = 40, SortID = 15 },
		},
		[13119] = 
		{
			[1] = { x = 295.49, y = 52.49, z = -61.56, name = "", level = 40, SortID = 16 },
		},
	},
	Npc = 
	{
		[2006] = 
		{
			[1] = { x = 296.63, y = 52.01, z = -70.83, name = "露娜·艾琳", SortID = 1 },
		},
		[2256] = 
		{
			[1] = { x = 298.40, y = 52.04, z = -67.04, name = "席崁族人", SortID = 4 },
			[2] = { x = 319.40, y = 48.85, z = -89.50, name = "席崁族人", SortID = 11 },
		},
		[2242] = 
		{
			[1] = { x = 295.49, y = 52.40, z = -61.47, name = "席崁兰尼", SortID = 10 },
		},
		[2033] = 
		{
			[1] = { x = 299.40, y = 49.07, z = -102.47, name = "席崁达里卫兵", SortID = 12 },
			[2] = { x = 305.58, y = 49.07, z = -78.69, name = "席崁达里卫兵", SortID = 13 },
		},
		[2257] = 
		{
			[1] = { x = 293.05, y = 52.47, z = -59.11, name = "", SortID = 14 },
		},
	},
	Region = 
	{
		[2] = 
		{
			[192] = { x = -229.11, y = -17.62, z = -158.52, name = "废弃小屋", worldId = 0, PkMode = 1 },
			[193] = { x = -198.14, y = 59.64, z = -65.22, name = "废弃的德法营地", worldId = 0, PkMode = 1 },
			[194] = { x = -283.94, y = 1.98, z = -68.46, name = "迷幻村落", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[195] = { x = -369.51, y = 2.10, z = 6.43, name = "亚伦之泉", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[197] = { x = -270.07, y = 0.17, z = -2.85, name = "北迷幻森林", worldId = 0, PkMode = 1 },
			[198] = { x = -200.71, y = -1.28, z = 114.12, name = "幻觉石之崖", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[199] = { x = -122.91, y = 5.71, z = -5.15, name = "朱拉丝长桥", worldId = 0, IsCanFind = 1, XMap = -155.8, YMap = 5.369486, ZMap = -1.2, PkMode = 1 },
			[200] = { x = -50.60, y = 31.00, z = -13.48, name = "法雷门营地", worldId = 0, PkMode = 1 },
			[201] = { x = 39.88, y = 30.46, z = 76.43, name = "罗琳镇", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[202] = { x = -59.39, y = 40.51, z = 59.73, name = "顶峰废墟", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[203] = { x = -39.66, y = 6.80, z = -116.19, name = "囚牢营", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[204] = { x = 256.07, y = 34.35, z = -43.22, name = "烈日峡谷", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[205] = { x = 319.85, y = 48.62, z = -89.62, name = "席坎村落", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[206] = { x = 333.08, y = 30.27, z = 67.90, name = "黑色祭坛", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[207] = { x = 257.78, y = -7.22, z = 42.66, name = "金属坟场", worldId = 0, IsCanFind = 1, PkMode = 1 },
			[208] = { x = 129.33, y = 15.05, z = -16.69, name = "法雷门旷野", worldId = 0, PkMode = 1 },
			[464] = { x = 310.93, y = 64.30, z = -85.58, name = "", worldId = 0, PkMode = 1 },
			[465] = { x = 293.21, y = 53.23, z = -58.44, name = "进入仪式", worldId = 0, PkMode = 1 },
		},
	},
	Mine = 
	{
	...
	Entity = 
	{
		[15] = 
		{
			x = 293.24, y = 52.47, z = -58.77, Type = 1,
			Tid = 
			{
				[13113] = 1,
			},
		...
		[16] = 
		{
			x = 295.49, y = 52.49, z = -61.56, Type = 1,
			Tid = 
			{
				[13119] = 1,
			},
		...
		[1] = 
		{
			x = 296.63, y = 52.01, z = -70.83, Type = 2,
			Tid = 
			{
				[2006] = 1,
			},
		...
		[4] = 
		{
			x = 298.40, y = 52.04, z = -67.04, Type = 2,
			Tid = 
			{
				[2256] = 10,
			},
		...
		[10] = 
		{
			x = 295.49, y = 52.40, z = -61.47, Type = 2,
			Tid = 
			{
				[2242] = 1,
			},
		...
		[11] = 
		{
			x = 319.40, y = 48.85, z = -89.50, Type = 2,
			Tid = 
			{
				[2256] = 15,
			},
		...
		[12] = 
		{
			x = 299.40, y = 49.07, z = -102.47, Type = 2,
			Tid = 
			{
				[2033] = 2,
			},
		...
		[13] = 
		{
			x = 305.58, y = 49.07, z = -78.69, Type = 2,
			Tid = 
			{
				[2033] = 2,
			},
		...
		[14] = 
		{
			x = 293.05, y = 52.47, z = -59.11, Type = 2,
			Tid = 
			{
				[2257] = 1,
			},
