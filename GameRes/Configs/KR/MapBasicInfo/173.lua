local MapInfo = 
{
	...
	Monster = 
	{
		[13032] = 
		{
			[1] = { x = -76.70, y = 31.98, z = -100.20, name = "사막 행인", level = 44, SortID = 42 },
		},
		[13033] = 
		{
			[1] = { x = -74.30, y = 31.98, z = -102.20, name = "사막 행인 용사", level = 44, SortID = 1 },
		},
	},
	Npc = 
	{
		[3046] = 
		{
			[1] = { x = -63.82, y = 31.98, z = -118.22, name = "엘프 탐험가", SortID = 91 },
		},
		[3047] = 
		{
			[1] = { x = -61.77, y = 31.98, z = -119.97, name = "엘프 생존자", SortID = 93 },
		},
		[3045] = 
		{
			[1] = { x = -36.80, y = 31.12, z = -80.04, name = "칸파소", SortID = 94 },
		},
		[3044] = 
		{
			[1] = { x = -39.21, y = 31.28, z = -80.37, name = "하이엘프 궁수", SortID = 95 },
		},
	},
	Region = 
	{
