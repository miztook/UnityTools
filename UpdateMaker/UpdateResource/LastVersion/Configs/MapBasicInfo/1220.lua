local MapInfo = 
{
	...
	Monster = 
	{
		[14222] = 
		{
			[1] = { x = 235.90, y = 22.52, z = -217.20, name = "腐化海盗", level = 52, SortID = 1, DropItemIds = " " },
			[2] = { x = 203.82, y = 27.65, z = -142.99, name = "腐化海盗", level = 52, SortID = 6, DropItemIds = " " },
			[3] = { x = 219.91, y = 27.65, z = -157.70, name = "腐化海盗", level = 52, SortID = 2, DropItemIds = " " },
			[4] = { x = 223.14, y = 27.65, z = -184.37, name = "腐化海盗", level = 52, SortID = 7, DropItemIds = " " },
			[5] = { x = 216.31, y = 27.65, z = -199.37, name = "腐化海盗", level = 52, SortID = 8, DropItemIds = " " },
			[6] = { x = 203.82, y = 27.65, z = -142.99, name = "腐化海盗", level = 52, SortID = 14, DropItemIds = " " },
		},
		[14221] = 
		{
			[1] = { x = 196.35, y = 27.65, z = -209.79, name = "腐化打手", level = 52, SortID = 4, DropItemIds = " " },
			[2] = { x = 196.35, y = 27.65, z = -209.79, name = "腐化打手", level = 52, SortID = 9, DropItemIds = " " },
			[3] = { x = 179.50, y = 27.65, z = -208.77, name = "腐化打手", level = 52, SortID = 12, DropItemIds = " " },
			[4] = { x = 156.06, y = 27.65, z = -185.03, name = "腐化打手", level = 52, SortID = 13, DropItemIds = " " },
		},
		[14249] = 
		{
			[1] = { x = 179.98, y = 27.65, z = -141.58, name = "不死士", level = 52, SortID = 15, DropItemIds = " " },
			[2] = { x = 161.70, y = 27.65, z = -154.45, name = "不死士", level = 52, SortID = 16, DropItemIds = " " },
			[3] = { x = 142.20, y = 24.11, z = -127.23, name = "不死士", level = 52, SortID = 17, DropItemIds = " " },
			[4] = { x = 151.31, y = 24.24, z = -136.88, name = "不死士", level = 52, SortID = 18, DropItemIds = " " },
		},
		[14223] = 
		{
			[1] = { x = 190.25, y = 20.93, z = -170.79, name = "腐化海盗船长", level = 52, SortID = 19, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[76] = 
		{
			[1] = { x = 237.14, y = 22.37, z = -219.84, name = "好望港守备军", SortID = 3, FunctionName = " " },
			[2] = { x = 138.32, y = 24.67, z = -121.50, name = "好望港守备军", SortID = 5, FunctionName = " " },
		},
		[4228] = 
		{
			[1] = { x = 238.16, y = 22.42, z = -230.73, name = "普布利", SortID = 11, FunctionName = " " },
		},
	},
	Region = 
	{
