local MapInfo = 
{
	...
	Monster = 
	{
		[22400] = 
		{
			[1] = { x = -9.08, y = 76.02, z = 74.70, name = "이스렌 수련자", level = 40,IsBoss = true },
		},
		[22401] = 
		{
			[1] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 40 },
			[2] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 40 },
			[3] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 40 },
			[4] = { x = -9.10, y = 76.02, z = 67.30, name = "환영", level = 40 },
			[5] = { x = -9.10, y = 76.02, z = 69.29, name = "환영", level = 40 },
		},
		[22403] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 40 },
		},
		[22404] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 40 },
		...
		[22406] = 
		{
			[1] = { x = -8.80, y = 57.66, z = -90.69, name = "타락한 요정", level = 40 },
		},
		[22402] = 
		{
			[1] = { x = -8.60, y = 76.02, z = 70.70, name = "환영", level = 40 },
		},
	},
	Npc = 
	{
