local MapInfo = 
{
	...
	Monster = 
	{
		...
		[10040] = 
		{
			[1] = { x = -218.22, y = 42.69, z = -146.29, name = "죽은 노예 병사", level = 18, SortID = 1 },
			[2] = { x = -222.03, y = 43.60, z = -152.02, name = "죽은 노예 병사", level = 18, SortID = 6 },
			[3] = { x = -217.74, y = 42.12, z = -161.92, name = "죽은 노예 병사", level = 18, SortID = 7 },
		},
		[10043] = 
		{
