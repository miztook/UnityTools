local MapInfo = 
{
	...
	Monster = 
	{
		[10038] = 
		{
			[1] = { x = -218.22, y = 42.69, z = -146.29, name = "帝国咒术师", level = 18, SortID = 1 },
			[2] = { x = -222.03, y = 43.60, z = -152.02, name = "帝国咒术师", level = 18, SortID = 6 },
			[3] = { x = -217.74, y = 42.12, z = -161.92, name = "帝国咒术师", level = 18, SortID = 7 },
		},
		[10039] = 
		{
			[1] = { x = -218.22, y = 42.69, z = -146.29, name = "帝国暗杀者", level = 18, SortID = 1 },
			[2] = { x = -222.03, y = 43.60, z = -152.02, name = "帝国暗杀者", level = 18, SortID = 6 },
			[3] = { x = -217.74, y = 42.12, z = -161.92, name = "帝国暗杀者", level = 18, SortID = 7 },
			[4] = { x = -222.43, y = 43.09, z = -137.83, name = "帝国暗杀者", level = 18, SortID = 10 },
			[5] = { x = -218.05, y = 43.17, z = -136.54, name = "帝国暗杀者", level = 18, SortID = 11 },
		},
		[10040] = 
		{
			[1] = { x = -218.22, y = 42.69, z = -146.29, name = "奴隶死士", level = 18, SortID = 1 },
			[2] = { x = -222.03, y = 43.60, z = -152.02, name = "奴隶死士", level = 18, SortID = 6 },
			[3] = { x = -217.74, y = 42.12, z = -161.92, name = "奴隶死士", level = 18, SortID = 7 },
		},
		[10043] = 
		{
			[1] = { x = -219.99, y = 42.54, z = -140.20, name = "卡莫·曼·坎迪斯", level = 18, SortID = 2 },
		},
	},
	Npc = 
	{
