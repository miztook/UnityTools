local MapInfo = 
{
	...
	Monster = 
	{
		[13131] = 
		{
			[1] = { x = 245.93, y = 36.24, z = -185.30, name = "风精灵士兵", level = 45, SortID = 6, DropItemIds = " " },
			[2] = { x = 233.95, y = 36.24, z = -185.30, name = "风精灵士兵", level = 45, SortID = 7, DropItemIds = " " },
			[3] = { x = 217.57, y = 36.24, z = -186.29, name = "风精灵士兵", level = 45, SortID = 8, DropItemIds = " " },
			[4] = { x = 174.09, y = 37.85, z = -179.08, name = "风精灵士兵", level = 45, SortID = 9, DropItemIds = " " },
			[5] = { x = 161.43, y = 37.85, z = -198.00, name = "风精灵士兵", level = 45, SortID = 10, DropItemIds = " " },
			[6] = { x = 184.66, y = 37.85, z = -199.70, name = "风精灵士兵", level = 45, SortID = 11, DropItemIds = " " },
			[7] = { x = 133.91, y = 37.81, z = -190.44, name = "风精灵士兵", level = 45, SortID = 12, DropItemIds = " " },
			[8] = { x = 162.80, y = 37.82, z = -163.06, name = "风精灵士兵", level = 45, SortID = 13, DropItemIds = " " },
			[9] = { x = 140.77, y = 22.64, z = -212.51, name = "风精灵士兵", level = 45, SortID = 14, DropItemIds = " " },
			[10] = { x = 237.52, y = 26.58, z = -166.44, name = "风精灵士兵", level = 45, SortID = 15, DropItemIds = " " },
			[11] = { x = 210.19, y = 26.58, z = -161.11, name = "风精灵士兵", level = 45, SortID = 16, DropItemIds = " " },
			[12] = { x = 142.09, y = 22.64, z = -219.55, name = "风精灵士兵", level = 45, SortID = 18, DropItemIds = " " },
			[13] = { x = 172.22, y = 31.38, z = -232.60, name = "风精灵士兵", level = 45, SortID = 20, DropItemIds = " " },
			[14] = { x = 143.52, y = 22.64, z = -226.52, name = "风精灵士兵", level = 45, SortID = 21, DropItemIds = " " },
		},
		[13132] = 
		{
			[1] = { x = 133.13, y = 22.64, z = -228.61, name = "风之祭司", level = 45, SortID = 17, DropItemIds = " " },
			[2] = { x = 142.09, y = 22.64, z = -219.55, name = "风之祭司", level = 45, SortID = 18, DropItemIds = " " },
			[3] = { x = 222.21, y = 26.58, z = -152.55, name = "风之祭司", level = 45, SortID = 19, DropItemIds = " " },
			[4] = { x = 143.52, y = 22.64, z = -226.52, name = "风之祭司", level = 45, SortID = 21, DropItemIds = " " },
		},
		[13133] = 
		{
			[1] = { x = 173.41, y = 37.85, z = -184.92, name = "哈里坎·怒风", level = 46, SortID = 22, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[3268] = 
		{
			[1] = { x = 188.43, y = 36.53, z = -225.82, name = "通信水晶", SortID = 1, FunctionName = " " },
		},
	},
	Region = 
	{
