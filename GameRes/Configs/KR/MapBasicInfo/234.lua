...
{
	MapType = 2,
	Remarks = "远征·伊斯莲试炼者·噩梦",
	TextDisplayName = "이스렌 시련자 - 악몽",
	Length = 256,
	Width = 256,
	...
	Monster = 
	{
		[22410] = 
		{
			[1] = { x = -9.00, y = 76.02, z = 86.82, name = "이스렌 수련자", level = 60,IsBoss = true },
		},
		[22411] = 
		{
			[1] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 60 },
			[2] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 60 },
			[3] = { x = -9.10, y = 76.26, z = 73.25, name = "환영", level = 60 },
			[4] = { x = -9.10, y = 76.02, z = 67.30, name = "환영", level = 60 },
			[5] = { x = -9.10, y = 76.02, z = 69.29, name = "환영", level = 60 },
		},
		[22413] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 60 },
		},
		[22414] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 60 },
		...
		[22415] = 
		{
			[1] = { x = 36.71, y = 64.99, z = -20.82, name = "환영", level = 60 },
		},
		[22416] = 
		{
			[1] = { x = -8.80, y = 57.66, z = -90.69, name = "타락한 엘프", level = 60 },
		},
		[22412] = 
		{
			[1] = { x = -8.60, y = 76.02, z = 70.70, name = "환영", level = 60 },
		},
	},
	Npc = 
	{
	...
	Entity = 
	{
		...
		[3] = 
		{
			x = -29.16, y = 75.96, z = 49.60, Type = 4,
			Tid = 
			{
				[15] = 0,
			},
	...
	TargetPoint = 
	{
		...
		[5] = { posx = -9.03, posy = 76.02, posz = 57.94, rotx = 0.00, roty = 0.00, rotz = 0.00 },
		[6] = { posx = -10.98, posy = 76.02, posz = 57.81, rotx = 0.00, roty = 0.00, rotz = 0.00 },
		[7] = { posx = -7.00, posy = 76.02, posz = 57.76, rotx = 0.00, roty = 0.00, rotz = 0.00 },
		[8] = { posx = -12.88, posy = 76.02, posz = 57.90, rotx = 0.00, roty = 0.00, rotz = 0.00 },
		[9] = { posx = -5.04, posy = 76.02, posz = 57.90, rotx = 0.00, roty = 0.00, rotz = 0.00 },
	},
