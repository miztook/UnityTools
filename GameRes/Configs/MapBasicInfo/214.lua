local MapInfo = 
{
	...
	Monster = 
	{
		[20410] = 
		{
			[1] = { x = -3.16, y = 54.41, z = -0.91, name = "巴哈勒试炼者", level = 58,IsBoss = true },
		},
		[20411] = 
		{
			[1] = { x = -3.33, y = 54.41, z = -1.59, name = "巴哈勒试炼者", level = 58 },
			[2] = { x = -3.26, y = 54.23, z = -3.11, name = "巴哈勒试炼者", level = 58 },
			[3] = { x = -3.26, y = 54.23, z = -3.11, name = "巴哈勒试炼者", level = 58 },
		},
		[20412] = 
		{
			[1] = { x = -3.20, y = 54.23, z = -1.20, name = "熔岩猎犬", level = 58 },
		},
		[20413] = 
		{
			[1] = { x = -3.60, y = 54.23, z = -1.52, name = "巴哈勒试炼者", level = 58 },
			[2] = { x = -3.28, y = 54.21, z = -1.23, name = "巴哈勒试炼者", level = 58 },
		},
		[20415] = 
		{
			[1] = { x = 1.85, y = 54.23, z = -9.47, name = "巴哈勒试炼者", level = 58 },
			[2] = { x = -11.29, y = 54.23, z = -6.08, name = "巴哈勒试炼者", level = 58 },
			[3] = { x = 5.27, y = 54.23, z = 3.77, name = "巴哈勒试炼者", level = 58 },
			[4] = { x = -7.69, y = 54.23, z = 7.05, name = "巴哈勒试炼者", level = 58 },
			[5] = { x = -2.96, y = 54.41, z = -0.75, name = "巴哈勒试炼者", level = 58 },
		},
	},
	Npc = 
	{
