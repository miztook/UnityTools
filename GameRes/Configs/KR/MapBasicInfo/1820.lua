local MapInfo = 
{
	...
	Monster = 
	{
		[14243] = 
		{
			[1] = { x = -201.30, y = 44.96, z = -86.60, name = "감염자", level = 57, SortID = 96, DropItemIds = " " },
			[2] = { x = -196.68, y = 44.96, z = -105.49, name = "감염자", level = 57, SortID = 23, DropItemIds = " " },
			[3] = { x = -219.29, y = 44.61, z = -108.22, name = "감염자", level = 57, SortID = 24, DropItemIds = " " },
			[4] = { x = -219.39, y = 44.96, z = -91.23, name = "감염자", level = 57, SortID = 25, DropItemIds = " " },
			[5] = { x = -207.59, y = 44.96, z = -109.21, name = "감염자", level = 57, SortID = 26, DropItemIds = " " },
			[6] = { x = -207.23, y = 44.96, z = -98.93, name = "감염자", level = 57, SortID = 11, DropItemIds = " " },
		},
		[14245] = 
		{
	...
	Npc = 
	{
		[4230] = 
		{
			[1] = { x = -198.02, y = 28.27, z = -223.76, name = "엘리사 쿠벨", SortID = 233, FunctionName = " " },
		},
		[3009] = 
		{
			[1] = { x = -207.19, y = 28.01, z = -212.49, name = "하이엘프 병사", SortID = 16, FunctionName = " " },
		},
	},
	Region = 
	{
