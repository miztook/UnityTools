local MapInfo = 
{
	...
	Npc = 
	{
		[2006] = 
		{
			[1] = { x = 296.63, y = 52.01, z = -70.83, name = "루나 엘린", SortID = 1 },
		},
		[2256] = 
		{
			[1] = { x = 298.40, y = 52.04, z = -67.04, name = "시칸족", SortID = 4 },
			[2] = { x = 319.40, y = 48.85, z = -89.50, name = "시칸족", SortID = 11 },
		},
		[2242] = 
		{
			[1] = { x = 295.49, y = 52.40, z = -61.47, name = "시칸레니", SortID = 10 },
		},
		[2033] = 
		{
			[1] = { x = 299.40, y = 49.07, z = -102.47, name = "시칸다리 병사", SortID = 12 },
			[2] = { x = 305.58, y = 49.07, z = -78.69, name = "시칸다리 병사", SortID = 13 },
		},
		[2257] = 
		{
	...
	Region = 
	{
		[2] = 
		{
			...
			[207] = { x = 257.78, y = -7.22, z = 42.66, name = "황금 무덤", worldId = 0, IsCanFind = 1, PkMode = 1 },
