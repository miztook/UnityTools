local MapInfo = 
{
	...
	Monster = 
	{
		[23100] = 
		{
			[1] = { x = 0.14, y = 6.70, z = -108.69, name = "혈전사", level = 40 },
		},
		[23102] = 
		{
			[1] = { x = 26.01, y = 2.75, z = -83.42, name = "시칸 병사", level = 40 },
			[2] = { x = 0.53, y = 1.87, z = -22.97, name = "시칸 병사", level = 40 },
		},
		[23104] = 
		{
			[1] = { x = 26.01, y = 2.75, z = -83.42, name = "데바 사제", level = 40 },
			[2] = { x = 0.53, y = 1.87, z = -22.97, name = "데바 사제", level = 40 },
		},
		[23106] = 
		{
			[1] = { x = 0.36, y = 5.77, z = -58.42, name = "데바 사제", level = 40 },
		},
		[23107] = 
		{
