...
public final class EmulatorDetector {
    ...
    private EmulatorDetector(Context pContext) {
        ...
        mListPackageName.add("com.bignox.app.store.hd");
    }
    ...
    public String getEmulatorString()
    {
        String emulatorName = "";
        ...
        if (result)
        {
           if (Build.MODEL.contains("google_sdk") || Build.PRODUCT.equals("google_sdk"))
               emulatorName = "GoogleSdk";
           else if (Build.MANUFACTURER.contains("Genymotion"))
               emulatorName = "Genymotion";
           else if (Build.HARDWARE.equals("goldfish"))
               emulatorName = "GoldFish";
           else if (Build.HARDWARE.equals("vbox86") || Build.PRODUCT.equals("vbox86p"))
               emulatorName = "Vbox";
        ...
        if (result)
        {
            if (checkFiles(GENY_FILES,"Geny"))
                ...
                emulatorName = "Nox";
            else if (checkQEmuDrivers() || (checkQEmuProps() && checkFiles(X86_FILES,"X86")))
                emulatorName = "QEMU";
            else
                emulatorName = "AndroidEmulator";
        ...
        if (result)
        {
            String pckName = checkPackageNameString();
            if (pckName == "com.google.android.launcher.layouts.genymotion")
                emulatorName = "Genymotion";
            else if (pckName.contains("com.bluestacks"))
                emulatorName = "BlueStacks";
            else if (pckName.contains("com.bignox.app"))
                emulatorName = "Nox";
            else
                emulatorName = "AndroidEmulator";
    ...
    private String checkPackageNameString() {
        if (!isCheckPackage || mListPackageName.isEmpty()) {
            return "";
        }
        final PackageManager packageManager = mContext.getPackageManager();
