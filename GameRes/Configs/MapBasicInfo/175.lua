local MapInfo = 
{
	...
	Monster = 
	{
		[50305] = 
		{
			[1] = { x = -249.22, y = 49.31, z = 155.53, name = "隐身怪物", level = 40, SortID = 6, DropItemIds = " " },
		},
		[50304] = 
		{
			[1] = { x = -238.63, y = 49.31, z = 151.97, name = "隐身怪物", level = 40, SortID = 7, DropItemIds = " " },
		},
		[50303] = 
		{
			[1] = { x = -242.94, y = 52.27, z = 178.54, name = "沙行者", level = 40, SortID = 8, DropItemIds = " " },
		},
		[50301] = 
		{
			[1] = { x = -242.94, y = 52.27, z = 178.54, name = "沙行者勇者", level = 40, SortID = 9, DropItemIds = " " },
		},
		[50302] = 
		{
			[1] = { x = -242.94, y = 52.27, z = 178.54, name = "沙行者首领", level = 40, SortID = 10, DropItemIds = " " },
		},
		[50306] = 
		{
			[1] = { x = -238.55, y = 49.31, z = 152.61, name = "隐身怪物", level = 40, SortID = 11, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[40201] = 
		{
			[1] = { x = -198.00, y = 54.68, z = 129.39, name = "芙萝·艾琳", SortID = 1, FunctionName = " " },
		},
		[40202] = 
		{
			[1] = { x = -198.00, y = 54.68, z = 129.39, name = "芙萝·艾琳", SortID = 2, FunctionName = " " },
			[2] = { x = -238.63, y = 49.31, z = 151.97, name = "芙萝·艾琳", SortID = 12, FunctionName = " " },
		},
	},
	Region = 
	{
