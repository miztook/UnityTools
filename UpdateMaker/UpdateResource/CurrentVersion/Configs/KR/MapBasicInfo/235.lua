local MapInfo = 
{
	...
	Monster = 
	{
		[22420] = 
		{
			[1] = { x = -8.99, y = 76.02, z = 86.55, name = "이스렌 수련자", level = 47,IsBoss = true },
		},
		[22421] = 
		{
			[1] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 47 },
			[2] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 47 },
			[3] = { x = -9.10, y = 76.02, z = 73.25, name = "환영", level = 47 },
			[4] = { x = -9.10, y = 76.02, z = 67.30, name = "환영", level = 47 },
			[5] = { x = -9.10, y = 76.02, z = 69.29, name = "환영", level = 47 },
		},
		[22423] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 47 },
		},
		[22424] = 
		{
			[1] = { x = 36.88, y = 64.99, z = -40.07, name = "환영", level = 47 },
		...
		[22425] = 
		{
			[1] = { x = 36.71, y = 64.99, z = -20.82, name = "환영", level = 47 },
		},
		[22426] = 
		{
		...
		[22422] = 
		{
			[1] = { x = -8.60, y = 76.02, z = 70.70, name = "환영", level = 47 },
		},
	},
	Npc = 
	{
