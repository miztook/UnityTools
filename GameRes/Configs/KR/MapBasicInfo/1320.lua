local MapInfo = 
{
	...
	Monster = 
	{
		...
		[14225] = 
		{
			[1] = { x = -31.06, y = 64.37, z = -160.91, name = "잔혹한 독충", level = 53, SortID = 3, DropItemIds = " " },
			[2] = { x = -27.28, y = 64.67, z = -179.49, name = "잔혹한 독충", level = 53, SortID = 4, DropItemIds = " " },
			[3] = { x = -29.47, y = 64.09, z = -197.35, name = "잔혹한 독충", level = 53, SortID = 8, DropItemIds = " " },
		},
		[14226] = 
		{
			[1] = { x = -29.77, y = 63.99, z = -217.12, name = "잔혹한 세이버투스", level = 53, SortID = 9, DropItemIds = " " },
			[2] = { x = -30.16, y = 65.87, z = -223.87, name = "잔혹한 세이버투스", level = 53, SortID = 10, DropItemIds = " " },
		},
	},
	Npc = 
	{
		[4227] = 
		{
			[1] = { x = -54.74, y = 67.22, z = -153.68, name = "망치", SortID = 200, FunctionName = " " },
		},
		[1039] = 
		{
