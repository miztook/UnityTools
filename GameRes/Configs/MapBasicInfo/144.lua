local MapInfo = 
{
	...
	Monster = 
	{
		...
		[12217] = 
		{
			[1] = { x = -189.09, y = -4.18, z = -65.14, name = "术士逃兵", level = 31, DropItemIds = " " },
		},
		[12218] = 
		{
			[1] = { x = -189.09, y = -4.18, z = -65.14, name = "剑士逃兵", level = 31, DropItemIds = " " },
		},
		[12219] = 
		{
	...
	Npc = 
	{
		...
		[2277] = 
		{
			[1] = { x = -189.06, y = -4.18, z = -65.21, name = "第二军团逃兵", FunctionName = " " },
		},
		[2278] = 
		{
			[1] = { x = -189.06, y = -4.18, z = -65.21, name = "第二军团逃兵", FunctionName = " " },
		...
		[2279] = 
		{
			[1] = { x = -189.06, y = -4.18, z = -65.21, name = "马克西姆斯", FunctionName = " " },
		},
		[2285] = 
		{
			[1] = { x = -196.78, y = -4.71, z = -70.12, name = "迪波", FunctionName = " " },
		},
		[2283] = 
		{
			[1] = { x = -190.75, y = -4.42, z = -73.96, name = "温妮莎·德佩拉", FunctionName = " " },
		},
		[2284] = 
		{
			[1] = { x = -192.05, y = -4.42, z = -70.63, name = "黑衣人", FunctionName = " " },
		},
		[2281] = 
		{
			[1] = { x = -191.43, y = -4.68, z = -67.93, name = "露娜·艾琳", FunctionName = " " },
		},
	},
	Region = 
	{
