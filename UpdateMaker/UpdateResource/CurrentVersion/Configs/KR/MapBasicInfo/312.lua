local MapInfo = 
{
	...
	Monster = 
	{
		[32054] = 
		{
			[1] = { x = 7.96, y = -37.64, z = -7.45, name = "드래곤", level = 45,IsBoss = true },
		},
		[32051] = 
		{
			[1] = { x = 8.26, y = -42.97, z = -71.25, name = "핏빛 도마뱀 알", level = 45 },
			[2] = { x = 8.26, y = -42.97, z = -96.25, name = "핏빛 도마뱀 알", level = 45 },
		},
		[32055] = 
		{
			[1] = { x = 22.04, y = -37.64, z = 2.42, name = "핏빛 도마뱀 알", level = 35 },
			[2] = { x = -6.40, y = -37.64, z = 2.33, name = "핏빛 도마뱀 알", level = 35 },
			[3] = { x = -6.40, y = -37.64, z = -23.94, name = "핏빛 도마뱀 알", level = 35 },
			[4] = { x = 22.44, y = -37.64, z = -23.94, name = "핏빛 도마뱀 알", level = 35 },
		},
		[32057] = 
		{
			[1] = { x = -6.40, y = -37.64, z = 2.33, name = "은신 몬스터", level = 50 },
			[2] = { x = 22.36, y = -37.64, z = 2.33, name = "은신 몬스터", level = 50 },
			[3] = { x = -6.40, y = -37.64, z = -23.94, name = "은신 몬스터", level = 50 },
			[4] = { x = 22.44, y = -37.64, z = -23.94, name = "은신 몬스터", level = 50 },
		},
		[32050] = 
		{
			[1] = { x = 8.26, y = -42.97, z = -77.55, name = "핏빛 도마뱀", level = 45 },
		},
	},
	Npc = 
	{
	...
	Region = 
	{
		[2] = 
		{
			...
			[201] = { x = 8.10, y = -35.93, z = -12.10, name = "boss区域", worldId = 0, PkMode = 1, CameraDistance = 15 },
		},
	},
	Mine = 
	{
