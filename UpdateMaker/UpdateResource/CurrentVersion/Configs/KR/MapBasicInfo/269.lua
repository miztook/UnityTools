local MapInfo = 
{
	...
	Monster = 
	{
		[14062] = 
		{
			[1] = { x = -13.90, y = 71.37, z = 83.44, name = "라칸 화신", level = 55, SortID = 2 },
		},
		[14063] = 
		{
			[1] = { x = -16.01, y = 71.37, z = 94.13, name = "시칸더 화신", level = 55, SortID = 3 },
		},
		[14064] = 
		{
			[1] = { x = 2.34, y = 71.37, z = 99.35, name = "이스렌 화신", level = 55, SortID = 5 },
		},
		[14065] = 
		{
			[1] = { x = 5.12, y = 71.37, z = 88.97, name = "로크 화신", level = 55, SortID = 6 },
		},
	},
	Npc = 
	{
		[4180] = 
		{
			[1] = { x = -6.93, y = 71.37, z = 68.76, name = "벨릭", SortID = 1 },
		},
	},
	Region = 
	{
