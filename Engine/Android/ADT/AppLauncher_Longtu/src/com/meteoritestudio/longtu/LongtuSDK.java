...
public class LongtuSDK {
    ...
    public static void UploadRoleInfo(final String rolejson) {
    	try {
    		...
    		roleinfo.setRoleCreateTime(String.format("%.0f", roleJsonObject.getDouble("roleCreateTime")));
    		roleinfo.setRoleLevelMTime(String.format("%.0f", roleJsonObject.getDouble("roleLevelMTime")));
	...
	public static void SetDataBreakPoint(final String point) {
		Log.w("LTUnionSDK", "SetDataBreakPoint: " + point);
