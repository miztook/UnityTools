local MapInfo = 
{
	...
	Monster = 
	{
		[202] = 
		{
			[1] = { x = 214.50, y = 68.86, z = -125.10, name = "어디 쳐봐!", level = 25, SortID = 1 },
			[2] = { x = 132.90, y = 58.06, z = -31.80, name = "어디 쳐봐!", level = 25, SortID = 2 },
			[3] = { x = 168.20, y = 62.66, z = -185.20, name = "어디 쳐봐!", level = 25, SortID = 3 },
		},
	},
	Npc = 
	{
