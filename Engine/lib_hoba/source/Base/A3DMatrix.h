...
public:		//	Operaitons
	...
	void TransformVector3(A3DVECTOR3& vect) const;
	void TransformVector3(A3DVECTOR3& vect, float& z) const;
	...
	A3DMATRIX4& operator=(const A3DMATRIX4& other)
	{
		ASSERT(this != &other);
	...
	static A3DMATRIX4 MatIdentity() { static A3DMATRIX4 m(IDENTITY); return m; }
	...
	void SetScale(const A3DVECTOR3& scale);
	void SetScale(float scale) { SetScale(A3DVECTOR3(scale, scale, scale)); }
...
//	Clear all elements to zero
inline void A3DMATRIX4::Clear()
{
	memset(M, 0, sizeof(M));
}

//	Set matrix to identity matrix
inline void A3DMATRIX4::Identity()
{
	_12 = _13 = _14 = 0.0f;
	_21 = _23 = _24 = 0.0f;
	_31 = _32 = _34 = 0.0f;
...
{
	A3DMATRIX4 matRet(A3DMATRIX4::CLEARED);
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
		{
