local MapInfo = 
{
	...
	Monster = 
	{
		...
		[32029] = 
		{
			[1] = { x = 7.96, y = -37.64, z = -7.45, name = "드래곤", level = 33,IsBoss = true },
		},
		[32031] = 
		{
			[1] = { x = 8.26, y = -42.97, z = -96.25, name = "핏빛 도마뱀 알", level = 15 },
			[2] = { x = 8.26, y = -42.97, z = -71.25, name = "핏빛 도마뱀 알", level = 15 },
		},
		[32032] = 
		{
			[1] = { x = 8.26, y = -37.64, z = -13.25, name = "핏빛 도마뱀 알", level = 15 },
		},
		[32001] = 
		{
			[1] = { x = 8.26, y = -42.97, z = -77.55, name = "핏빛 도마뱀", level = 33 },
		},
	},
	Npc = 
	{
	...
	Region = 
	{
		[2] = 
		{
			...
			[201] = { x = 8.10, y = -35.93, z = -9.70, name = "boss区域", worldId = 0, PkMode = 1, CameraDistance = 15 },
		},
	},
	Mine = 
	{
