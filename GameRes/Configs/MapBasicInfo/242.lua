local MapInfo = 
{
	...
	Monster = 
	{
		[23120] = 
		{
			[1] = { x = 0.14, y = 6.70, z = -110.45, name = "血武者", level = 40 },
			[2] = { x = 0.14, y = 6.70, z = -105.58, name = "血武者", level = 40 },
		},
		[23122] = 
		{
			[1] = { x = 21.98, y = 0.93, z = -83.42, name = "席坎卫兵", level = 40 },
			[2] = { x = 27.18, y = 0.93, z = -83.42, name = "席坎卫兵", level = 40 },
			[3] = { x = 0.53, y = 1.87, z = -22.97, name = "席坎卫兵", level = 40 },
		},
		[23124] = 
		{
			[1] = { x = 27.18, y = 0.93, z = -83.42, name = "德法祭祀", level = 40 },
			[2] = { x = 0.53, y = 1.87, z = -22.97, name = "德法祭祀", level = 40 },
		},
		[23126] = 
		{
			[1] = { x = -0.04, y = 5.77, z = -59.36, name = "德法祭祀", level = 40 },
		},
		[23127] = 
		{
			[1] = { x = -0.04, y = 5.77, z = -59.36, name = "席坎卫兵", level = 40 },
			[2] = { x = 5.06, y = 5.77, z = -58.30, name = "席坎卫兵", level = 40 },
		},
		[23123] = 
		{
